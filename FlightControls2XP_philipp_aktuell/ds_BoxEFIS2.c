...
ds_error ds_initialize_EFIS_2(char *box, char *s1)
{
	...
	sprintf(aliasname0, "%s.COP.PNL.GLA.EFIS2.control_knob0", s1);
	sprintf(aliasname1, "%s.COP.PNL.GLA.EFIS2.inc_dial0", s1);
	sprintf(aliasname2, "%s.COP.PNL.GLA.EFIS2.lcd_counter0", s1);
	sprintf(aliasname3, "%s.COP.PNL.GLA.EFIS2.lcd_textlight0", s1);
	sprintf(aliasname4, "%s.COP.PNL.GLA.EFIS2.push_button0", s1);
	sprintf(aliasname5, "%s.COP.PNL.GLA.EFIS2.push_button1", s1);
	sprintf(aliasname6, "%s.COP.PNL.GLA.EFIS2.radio_button0", s1);
	sprintf(aliasname7, "%s.COP.PNL.GLA.EFIS2.radio_button1", s1);
	sprintf(aliasname8, "%s.COP.PNL.GLA.EFIS2.radio_button2", s1);
	sprintf(aliasname9, "%s.COP.PNL.GLA.EFIS2.radio_button3", s1);
	sprintf(aliasname10, "%s.COP.PNL.GLA.EFIS2.radio_button4", s1);
	sprintf(aliasname11, "%s.COP.PNL.GLA.EFIS2.rot_switch0", s1);
	sprintf(aliasname12, "%s.COP.PNL.GLA.EFIS2.rot_switch1", s1);
	sprintf(aliasname13, "%s.COP.PNL.GLA.EFIS2.rot_switch2", s1);
	sprintf(aliasname14, "%s.COP.PNL.GLA.EFIS2.toggle_switch0", s1);
	sprintf(aliasname15, "%s.COP.PNL.GLA.EFIS2.toggle_switch1", s1);
	...
	fail = ds_create_box(box, sizeof(EFIS2), (char *)&tempstruct,
